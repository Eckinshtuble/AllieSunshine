    ...
    <div class="legacy-wrap">
        <div class="legacy-wrap-inner">
            ...
            <p class="long-copy">
                ...
                of conscious wellness. The depth of health depends on one's ability to sustain
        ...
        <div class="legacy-wrap-inner-bottom">
            ...
            <img src="{{ asset('/images/Carousel2.jpg') }}" alt="legacy" width="380" height="430">
            <p class="long-copy">
                ...
                our self renewing community of care. Our central project is the Healing Garden. This is a
                ...
                and aha's. We are a community of action and we put our learning into motion by voting with
